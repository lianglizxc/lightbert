...
from albertlib.albert import AlbertModel
...
class ALBertPretrainLossAndMetricLayer(tf.keras.layers.Layer):
  ...
  def _add_metrics(self, lm_output, lm_labels, lm_label_weights,
    ...
    lm_example_loss = tf.reduce_sum(lm_example_loss * lm_label_weights) / tf.reduce_sum(lm_label_weights)
...
def pretrain_model(albert_config,
  ...
  return tf.keras.Model(
      ...
      outputs=[output_loss, lm_output]),albert_submodel