...
flags.DEFINE_enum("model_type","albert_encoder",["albert_encoder","albertlib"],
                  "Select model type for weight conversion.\n"
                  "albert_enoder for finetuning tasks.\n"
                  "albertlib for MLM & SOP FineTuning on domain specific data.")
...
def main(_):
    ...
    print("Done loading {} ALBERT weights from: {} into {} (prefix:{}). "
          ...
          "Count of weights with mismatched shape: [{}]".format(
              len(weight_value_tuples), tfhub_model_path, albert_layer, "albertlib", skip_count, len(skipped_weight_value_tuples)))
