  ...
  with strategy.scope():
    ...
    def _replicated_step(inputs):
      ...
      with tf.GradientTape() as tape:
        model_outputs, lm_output = model(inputs, training=True)
    ...
    def train_steps(iterator, steps):
      ...
      for _ in tf.range(steps):
        output = strategy.run(_replicated_step, args=(next(iterator),))
      return output
    ...
    def _run_callbacks_on_batch_begin(batch, logs=None):
    ...
    def _run_callbacks_on_batch_end(batch, logs=None):
    ...
    while current_step < total_training_steps:
      ...
      if steps == 1:
        ...
        input, lm_output = train_single_step(train_iterator)
      else:
        # Converts steps to a Tensor to avoid tf.function retracing.
        input, lm_output = train_steps(train_iterator,
      ...
      if current_step != 0 and current_step % steps_per_epoch == 0:
